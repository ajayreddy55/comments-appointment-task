    ...
    <div className="money-bg-container">
      ...
      <div className="container-fluid mt-3 mb-3">
        <div className="row d-flex align-items-stretch justify-content-between">
          <div className="money-balance-container col-12 col-md-4 col-lg-3 mr-1">
            <img
          ...
          <div className="money-income-container col-12 col-md-4 col-lg-3 mr-1">
            <img
          ...
          <div className="money-expenses-container col-12 col-md-4 col-lg-3 mr-1">
            <img
      ...
      <div className="container-fluid mt-4 mb-4">
        <div className="row d-flex align-items-stretch justify-content-between">
          <form
            className="money-input-card col-12 col-md-5"
            onSubmit={submitTheIncomeDetails}
          >
          ...
          <div className="money-details-table-container col-12 col-md-6">
